...
# Example aliases
 ...
 alias picom-conf="nvim ~/.config/picom/picom.conf"
 alias polybar-ini="nvim ~/.config/polybar/config.ini"
 alias dunstrc="nvim ~/.config/dunst/dunstrc"
 alias ldmconfig="sudo nvim /etc/lightdm/lightdm-webkit2-greeter.conf"
